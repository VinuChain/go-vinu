...
const (
	...
	MaxTxGasLimit         uint64 = 1 << 24 // EIP-7825 per-transaction gas cap.
	...
	TxAuthTupleGas            uint64 = 12500 // Per authorization tuple specified in EIP 7702
	...
	MaxInitCodeSize = 2 * MaxCodeSize // Maximum initcode to permit in creation transactions and create instructions
...
// Gas discount tables for BLS12-381 G1 and G2 multi exponentiation operations.
