...
// resolveCode returns account code. After Prague, it follows a single
...
// resolveCodeHash returns the hash used for jumpdest analysis. After Prague,
// it follows a single EIP-7702 delegation designator.
